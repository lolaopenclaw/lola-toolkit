...
## 🔴 CORE
- `memory/core.md` — Manu basics (email, timezone, devices)
...
## 🤖 PROTOCOLS
- `memory/protocols.md` — General protocols (backup, security, automation)
- `memory/verification-protocol.md` — Evidence-before-assertions discipline
- `memory/night-notification-protocol.md` — Quiet hours enforcement (00:00-07:00)
...
- Latest log: `memory/autoimprove-log-2026-03-26.md`

## 🐙 GITHUB
lolaopenclaw | lola-toolkit public | Policy: code ✅ secrets/keys/IPs ❌

## 🧠 ENTITIES → `memory/entities/`
Auto-managed knowledge graph (SKIP autoimprove)

## 📚 BEST PRACTICES → `memory/best-practices/`
Anthropic, Google, OpenAI model best practices

## 🎯 PROJECTS → `memory/projects/`
CEO research, active initiatives
