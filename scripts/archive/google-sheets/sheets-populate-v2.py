...
def parse_usage_report(date_str):
    ...
    search_paths = [
        ...
        WORKSPACE / "memory" / "archive" / f"{date_str}-usage-report.md",
        WORKSPACE / "memory" / "archive" / "feb-2026" / f"{date_str}-usage-report.md",
        WORKSPACE / "memory" / "archive" / "feb-2026" / "DAILY" / "WARM" / f"{date_str}-usage-report.md",
    ]
    ...
    if today_section:
        # Extract total (support both $ and €)
