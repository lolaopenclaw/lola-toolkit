...
- **[preference]** Manu's priority: Wants to do this. Not urgent but important. 'Me parece una idea brillante. Daño no nos hace ninguno.'
- **[context]** Collections planned: 1) memory/ (daily notes, entities, protocols), 2) workspace/ (SOUL.md, MEMORY.md, PROJECTS.md), 3) scripts/ (documentation).

---

See `qmd-local-search.json` for all 4 facts.